      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-10 text-sm font-sans leading-relaxed text-text-2">
          ...
          <section>
            ...
            <p>
              Ao fornecer seu e-mail e clicar em &ldquo;entrar na lista&rdquo;, você consente em receber comunicações sobre o desenvolvimento e o lançamento da MUTAV. A inscrição não cria qualquer vínculo contratual, não garante acesso antecipado ao produto e não implica qualquer obrigação financeira.
            </p>
            <p className="mt-3">
