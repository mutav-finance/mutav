...
| Average monthly contract growth            | ~300–400/month           | Ramps as agency network expands                        |
...
| Withdrawal fee                             | 0.25%                    | MUTAV Soluções revenue                                 |
...
| Milestone                 | Contracts needed | Direct revenue   | **% of TAM** |
| ------------------------- | ---------------- | ---------------- | ------------ |
| Stage 1 (founders only)   | ~125             | ~R$5,000/month   | ~0.001%      |
| Stage 2 (structured team) | ~2,038           | ~R$81,500/month  | ~0.023%      |
| Year 1 target             | ~2,500           | ~R$100,000/month | ~0.025%      |
